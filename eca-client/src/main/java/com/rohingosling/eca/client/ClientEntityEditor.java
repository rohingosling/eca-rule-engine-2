...
final class ClientEntityEditor
{
    ...
    Node getNode ()
    {
        // Initialize the scroll pane with a new scroll pane.

        ScrollPane scrollPane = new ScrollPane ( this.root );

        // Perform the set fit to width, set pannable, add, and get style class calls required by the get node
        // operation.
        ...
        // Return the scroll pane to the caller.
    ...
    private void showCategoryGrid ( String categoryIdentifier )
    {
        ...
        Button duplicateButton = new Button ( text ( "button.duplicate" ) );
        ...
        VBox gridContent = new VBox (
            10.0,
            entityTable,
            ClientMain.createGroupActionRow (
                addButton,
                duplicateButton,
                editButton,
                deleteButton
    ...
    )
    {
        ...
        sections.getChildren ().add (
            ClientMain.createPageActionFooter ( applyButton, cancelButton )
        );
