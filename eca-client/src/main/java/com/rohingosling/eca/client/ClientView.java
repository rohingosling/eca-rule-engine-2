...
public interface ClientView
{
    ...
    // Description:
    //
    //   Enumerates the actions available when an operation would replace a document containing unsaved changes.
    //
    //-----------------------------------------------------------------------------------------------------------------
    ...
    //
    //   canSave (boolean):
    //     Indicates whether the current operation can save before continuing.
    //
    // Returns:
    //
    ...
    DirtyDocumentDecision chooseDirtyDocumentDecision ( String actionName, boolean canSave );
